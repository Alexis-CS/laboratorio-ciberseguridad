...
* **Laboratorio 3: Protocolos de Comunicación Seguros y Análisis de Tráfico:** Intercepción de datos en texto plano mediante *Sniffing* (**Wireshark**), configuración y despliegue de certificados de seguridad **TLS/HTTPS** y tunelización segura a través de **SSH** y **VPN (WireGuard/OpenVPN)** para garantizar la privacidad en tránsito.
